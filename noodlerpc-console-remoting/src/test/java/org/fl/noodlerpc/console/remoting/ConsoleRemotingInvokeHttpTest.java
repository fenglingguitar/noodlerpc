package org.fl.noodlerpc.console.remoting;
...
@ContextConfiguration(locations = {
		"classpath:org/fl/noodlerpc/console/remoting/noodlerpc-console-remoting-invoke-http.xml"
})
public class ConsoleRemotingInvokeHttpTest extends AbstractJUnit4SpringContextTests {
	...
	public void testServerRegister() throws Exception {
		...
		serviceVo.setInteface_Name("org.fl.noodlerpc.core.connect.net.TestNetService");
