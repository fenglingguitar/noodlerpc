...
import org.fl.noodlerpc.core.connect.net.constent.NetConnectClusterType;
import org.fl.noodlerpc.core.connect.net.constent.NetConnectRouteType;
import org.fl.noodlerpc.core.connect.net.constent.NetConnectSerializeType;
import org.fl.noodlerpc.core.connect.net.export.InvokerPool;
import org.fl.noodlerpc.core.connect.net.hessian.server.HessianHttpReceiver;
import org.fl.noodlerpc.core.connect.net.http.receiver.HttpReceiverPool;
import org.fl.noodlerpc.core.connect.net.http.server.DefaultHttpReceiver;
import org.fl.noodlerpc.core.connect.net.netty.receiver.NettyReceiver;
import org.fl.noodlerpc.core.connect.net.netty.receiver.NettyReceiverPool;
import org.fl.noodlerpc.core.connect.net.register.NetServerModuleRegister;
import org.fl.noodlerpc.core.connect.net.rpc.InvokerImpl;
import org.fl.noodlerpc.core.connect.net.serialize.JsonNetConnectSerialize;
import org.fl.noodlerpc.core.connect.net.util.NetServiceTools;
...
public class ServiceExporter implements InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
		...
		localUrl = localUrl == null ? "/noodlerpc/" + serializeType.getCode().toLowerCase() +  "/" + serviceName : localUrl;
